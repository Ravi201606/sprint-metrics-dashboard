...
*   **Definition:** The percentage of all issues in the sprint that are classified as defects or bugs.
*   **Formula:**
    $$\text{DIR} = \left( \frac{\text{Number of Defects/Bugs in Sprint}}{\text{Total Number of Issues in Sprint}} \right) \times 100$$
...
*   **Definition:** The percentage of completed issues that went from start to release without requiring any testing rework (i.e. QA verified and passed them on the very first attempt).
*   **Formula:**
    $$\text{FPY} = \left( \frac{\text{Completed Issues with 0 Testing Rework Hours}}{\text{Total Completed Issues}} \right) \times 100$$
*   **Dashboard Presentation:** Displays the overall FPY percentage, along with the total count of completed/delivered defects in the sprint below it.
*   **Agile Significance:** FPY is a primary indicator of engineering quality and testing efficiency. A low FPY indicates a "ping-pong" effect between developers and testers, which wastes capacity and increases cycle time.
