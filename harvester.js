...
const JIRA_FIELDS = ['summary', 'status', 'issuetype', 'assignee', 'priority', 'created', 'updated', 'resolutiondate', 'project', 'worklog', 'customfield_12041', 'resolution', 'changelog'];
...
const processIssue = (issue, isDiscovery, sprintNameMap) => {
    ...
    for (const sprint of issueSprints) {
        insertIssueSprint.run(sprint.issue_key, sprint.sprint_id, sprint.sprint_name, sprint.added_at, sprint.removed_at);
    }
};
